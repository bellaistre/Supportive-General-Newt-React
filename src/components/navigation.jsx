...
import Logo from '../assets/GNC-LOGO-SIMPLE-CENTRE-TRANSPARENT.svg?react'
          ...
          <a href="/">
            ...
            >
              ...
              <span className="section-title navigation-brand-text">
                <span>{t('SectionTitle_BXBAEJ')}</span>
              </span>
            </div>
          </a>
        ...
        <div className="navigation-mobile-header">
          <a href="/">
            ...
            >
              ...
              <span className="section-title navigation-brand-text">
                <span>{t('SectionTitle_8eI9jc')}</span>
              </span>
            </div>
          </a>
          <button
            ...
            <a href="#solution">
              <div className="navigation-mobile-link">
                <span className="nav-number">
                  <span>{t('NavNumber_Q4QM0w')}</span>
                </span>
                <span className="nav-text">
                  <span>{t('NavText_-CzSac')}</span>
                </span>
              </div>
            </a>
            <a href="#impact">
              <div className="navigation-mobile-link">
                <span className="nav-number">
                  <span>{t('NavNumber_zI_rwo')}</span>
                </span>
                <span className="nav-text">
                  <span>{t('NavText_REj3Lv')}</span>
                </span>
              </div>
            </a>
            <a href="#digital-twin">
              <div className="navigation-mobile-link">
                <span className="nav-number">
                  <span>{t('NavNumber_ntuitc')}</span>
                </span>
                <span className="nav-text">
                  <span>{t('NavText_JcQJ4r')}</span>
                </span>
              </div>
            </a>
            <a href="#leasing">
              <div className="navigation-mobile-link">
                <span className="nav-number">
                  <span>{t('NavNumber_PpNdpy')}</span>
                </span>
                <span className="nav-text">
                  <span>{t('NavText_nazYpP')}</span>
                </span>
              </div>
            </a>
          </div>
          <div className="navigation-mobile-footer">
            <a href="#contact">
              <div className="btn-primary btn btn-lg">
                <span>
                  <span>{t('text_JMAbHg')}</span>
                </span>
              </div>
            </a>
            <p className="navigation-tagline section-content">
              <span>{t('SectionContent_m85Utj')}</span>
            </p>
          </div>
        </div>
      </div>
